...
<!---->
			...
			%>
				...
				<ul class="start">
					...
					<li><a href="Blog-2.jsp">Prev</a></li>
					<li><a href="Blog.jsp">1</a></li>
					<li><a href="Blog-2.jsp">2</a></li>
					<li><span>3</span></li>
