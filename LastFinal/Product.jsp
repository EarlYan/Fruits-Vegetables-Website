...
<!---->
			<div class="container">
				...
				<ul id="filters">
						<li class="active"><span class="filter" data-filter="app card icon logo  web">所有产品</span></li>
						<li><span class="filter" data-filter="app">进口蔬菜</span></li>
						<li><span class="filter" data-filter="card">进口水果 </span></li>
						<li><span class="filter" data-filter="icon">国产蔬菜</span></li>
						<li><span class="filter" data-filter="logo">国产水果</span></li>
					</ul>
					<%
							GetTypeFromId gtfiforiv=new GetTypeFromId();
							ArrayList idListForiv = new ArrayList();
							idListForiv=gtfiforiv.getId("进口蔬菜");
							for(int i=0;i<idListForiv.size();i++)
							{
					%>
					<div id="portfoliolist">
					<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper ">		
							<a href="Single.jsp?productid=<%out.println(idListForiv.get(i));%>" class="b-link-stripe b-animate-go  thickbox play-icon">
						  <img class="img-responsive" src="images/<%out.println(idListForiv.get(i));%>.jpg" alt="" />
					...
					<%
							GetTypeFromId gtfiforif=new GetTypeFromId();
							ArrayList idListForif = new ArrayList();
							idListForif=gtfiforif.getId("进口水果");
							for(int i=0;i<idListForif.size();i++)
							{
					%>	
					<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper ">		
							<a href="Single.jsp?productid=<%out.println(idListForif.get(i));%>" class="b-link-stripe b-animate-go  thickbox play-icon ">
						     <img class="img-responsive" src="images/<%out.println(idListForif.get(i));%>.jpg" alt=""  />
						     <ul class="social-ic">
								<li class="down"><span> </span></li>
								<li class="in-search"><span> </span></li>
							</ul>
					...
					<%
							GetTypeFromId gtfifordv=new GetTypeFromId();
							ArrayList idListFordv = new ArrayList();
							idListFordv=gtfifordv.getId("国产蔬菜");
							for(int i=0;i<idListFordv.size();i++)
							{
					%>	
					<div class="portfolio icon mix_all" data-cat="icon" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a href="Single.jsp?productid=<%out.println(idListFordv.get(i));%>" class="b-link-stripe b-animate-go  thickbox play-icon ">
						     <img class="img-responsive" src="images/<%out.println(idListFordv.get(i));%>.jpg" alt=""  />
						    <ul class="social-ic">
								<li class="down"><span> </span></li>
								<li class="in-search"><span> </span></li>
							</ul>
					...
					<%
							GetTypeFromId gtfifordf=new GetTypeFromId();
							ArrayList idListFordf = new ArrayList();
							idListFordf=gtfifordf.getId("国产水果");
							for(int i=0;i<idListFordf.size();i++)
							{
					%>	
					<div class="portfolio logo mix_all" data-cat="logo" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper">		
							<a href="Single.jsp?productid=<%out.println(idListFordf.get(i));%>" class="b-link-stripe b-animate-go  thickbox play-icon ">
						     <img class="img-responsive" src="images/<%out.println(idListFordf.get(i));%>.jpg" alt=""  />
						    <ul class="social-ic">
								<li class="down"><span> </span></li>
								<li class="in-search"><span> </span></li>
							</ul>
