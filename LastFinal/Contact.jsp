...
<!---->
		...
		<div class="container">
			<div class="contact">
			<h3>CONTACT FORM</h3>
			<form action="ContactSave.action" method="post">
<div class="contact-grid">
						<div class="col-md-6 contact-us">
							<input type="text" name="name" value="name" onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Name';}">
						</div>
						<div class="col-md-6 contact-us">
							<input type="text" name="email" value="email" onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Email-id';}">
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="contact-grid">
					...
					<textarea cols="77" rows="6" name="message" value="message" onfocus="this.value='';" onblur="if (this.value == '') {this.value = 'Message';}">Message</textarea>
					<div class="send ">
